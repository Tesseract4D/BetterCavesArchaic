...
import cn.tesseract.bettercaves.noise.NoiseSettings;
...
public class CarverSettings {
    ...
    /* -------------------- Debug Params ------------------- */
    private Block debugBlock;             // Block used to represent this cave/cavern type in the debug visualizer
    ...
    public Block getDebugBlock() {
        return debugBlock;
    }

    public void setDebugBlock(Block debugBlock) {
